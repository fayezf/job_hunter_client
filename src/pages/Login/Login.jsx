    ...
    return (
        <div className='h-screen'>
            <div className='flex items-center min-h-screen'>
                <div className='flex justify-center items-center w-fit mx-auto rounded-xl bg-slate-200 h-[500px]'>
                    <div className='w-1/2 h-[500px]'>
                        <img className='rounded-s-xl h-full' src={loginImage} alt="" />
                    </div>
                    <div className='p-10 w-1/2'>
                        ...
                        <form>
                            ...
                            <div className='mt-5'>
                                <Link to='/register'><button className='border-[#2563EB] text-[#2563EB] border-2 py-3 rounded hover:bg-blue-800 ease-in-out duration-200 cursor-pointer w-full hover:text-white'>Register</button></Link>
                            </div>
                        </form>
                    </div>
                </div>
